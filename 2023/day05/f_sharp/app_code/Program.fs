...
task {
    ...
    let path = "/workspaces/adventofcode/2023/day05/problem_solution_input/full_data.txt"
    //let path = "/workspaces/adventofcode/2023/day05/problem_solution_input/sample_data.txt"
    ...
    let part_b_min_seed = Array.Parallel.map (fun (x: SeedRange) -> x.FindMinSeedInRange map_layers) seed_ranges |> Array.min
