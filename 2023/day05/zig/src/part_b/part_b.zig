...
fn extract_seed_ranges_from_string(allocator: std.mem.Allocator, seed_string: []const u8) error{ OutOfMemory, InvalidCharacter, Overflow }![]seed_range.SeedRange {
...
pub fn part_b(file_path: []const u8) !u64 {
    ...
    while (reader.interface.takeDelimiterExclusive('\n')) |line| {
        ...
        if (seed_string != null) {
            seed_ranges = try extract_seed_ranges_from_string(allocator, line);
            continue;
        }
