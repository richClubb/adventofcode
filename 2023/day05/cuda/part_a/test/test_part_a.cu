...
int main()
{
    ...
    CU_add_test(suite, "Test part a sample", test_part_a_sample_data);
    CU_add_test(suite, "Test part a full input", test_part_a_full_data);
    CU_basic_run_tests();
    CU_cleanup_registry();
    return 0;
}