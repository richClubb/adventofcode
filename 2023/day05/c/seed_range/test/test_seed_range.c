...
void test_sort_by_size_1()
{
    {
        uint64_t num_seed_ranges = 0;
        SEED_RANGE *seed_ranges = get_seed_ranges("seeds: 1 2 5 6 3 3", &num_seed_ranges);
...
void test_sort_by_size_2()
{
    {
        uint64_t num_seed_ranges = 0;
        SEED_RANGE *seed_ranges = get_seed_ranges("seeds: 28965817 302170009 1752849261 48290258 804904201 243492043 2150339939 385349830 1267802202 350474859 2566296746 17565716 3543571814 291402104 447111316 279196488 3227221259 47952959 1828835733 9607836", &num_seed_ranges);
        
        CU_ASSERT_EQUAL_FATAL(num_seed_ranges, 10);
        CU_ASSERT_PTR_NOT_NULL_FATAL(seed_ranges);

        sort_seed_ranges_by_size(seed_ranges, num_seed_ranges);

        CU_ASSERT_EQUAL(seed_ranges[0].start, 1828835733);
        CU_ASSERT_EQUAL(seed_ranges[0].size,  9607836);
        CU_ASSERT_EQUAL(seed_ranges[1].start, 2566296746);
        CU_ASSERT_EQUAL(seed_ranges[1].size,  17565716);
        CU_ASSERT_EQUAL(seed_ranges[2].start, 3227221259);
        CU_ASSERT_EQUAL(seed_ranges[2].size,  47952959);
        CU_ASSERT_EQUAL(seed_ranges[3].start, 1752849261);
        CU_ASSERT_EQUAL(seed_ranges[3].size,  48290258);
        CU_ASSERT_EQUAL(seed_ranges[4].start, 804904201);
        CU_ASSERT_EQUAL(seed_ranges[4].size,  243492043);
        CU_ASSERT_EQUAL(seed_ranges[5].start, 447111316);
        CU_ASSERT_EQUAL(seed_ranges[5].size,  279196488);
        CU_ASSERT_EQUAL(seed_ranges[6].start, 3543571814);
        CU_ASSERT_EQUAL(seed_ranges[6].size,  291402104);
        CU_ASSERT_EQUAL(seed_ranges[7].start, 28965817);
        CU_ASSERT_EQUAL(seed_ranges[7].size,  302170009);
        CU_ASSERT_EQUAL(seed_ranges[8].start, 1267802202);
        CU_ASSERT_EQUAL(seed_ranges[8].size,  350474859);
        CU_ASSERT_EQUAL(seed_ranges[9].start, 2150339939);
        CU_ASSERT_EQUAL(seed_ranges[9].size,  385349830);
        free(seed_ranges);
    }
}
...
int main()
{
    ...
    CU_add_test(suite, "Test get seed ranges 3", test_sort_by_size_1);
    CU_add_test(suite, "Test get seed ranges 3", test_sort_by_size_2);
    CU_add_test(suite, "Test get seed ranges 3", test_sort_by_start);
